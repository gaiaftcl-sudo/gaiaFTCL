//! Train gaialm_math_core from Math teacher harvests
//!
...
fn main() {
    ...
    println!();
    println!("═══════════════════════════════════════════════════════════════");
    println!("🧮 GAIALM DISTILLATION: Math → gaialm_math_core");
    println!("═══════════════════════════════════════════════════════════════");
    println!();
    ...
    // Configure training for math
    let mut config = TrainConfig::math();
    config.harvest_path = gaiaos_root.join("services/teacher_harvest/harvest_data/math_harvest.json");
    ...
    let examples = match load_fara_harvest(&config.harvest_path) {
        ...
        Err(e) => {
            ...
            println!("   cargo run --bin harvest_math");
            return;
        }
    };
    ...
    println!();
    println!("═══════════════════════════════════════════════════════════════");
    println!("✅ MATH DISTILLATION COMPLETE");
    println!("═══════════════════════════════════════════════════════════════");
    println!();
    println!("Next: cargo run --bin gaialm_eval_math");
    println!();
}
