...
```bash
# Copy to your repo
cp fusion_ui_full_test.applescript ~/Documents/FoT8D/cells/fusion/tests/
...
-- Write JSON receipt
try
	set receiptPath to do shell script "echo $HOME/Documents/FoT8D/cells/fusion/evidence/native_fusion/"
