...
> vitest run
 ...
 Test Files  6 passed (6)
      Tests  31 passed (31)
   Start at  08:45:12
   Duration  955ms (transform 329ms, setup 0ms, collect 562ms, tests 38ms, environment 1ms, prepare 1.16s)
...
Running 23 tests using 1 worker
  ...
  ✓   3 [chromium] › tests/fusion/fusion_mac_wasm_gate.spec.ts:60:7 › fusion_mac_wasm_gate › fusion-s4 renders active operator surface (not stuck splash) (623ms)
  ...
  ✓   5 [chromium] › tests/fusion/fusion_s4_console.spec.ts:265:7 › Fusion S4 console › fusion console swap panel mounts after mooring transition (1.1s)
  ✓   6 [chromium] › tests/fusion/fusion_s4_console.spec.ts:280:7 › Fusion S4 console › GET /api/fusion/s4-projection contract (765ms)
  ✓   7 [chromium] › tests/fusion/fusion_s4_console.spec.ts:392:7 › Fusion S4 console › GET /api/fusion/mesh-operator-spine contract (123ms)
  ✓   8 [chromium] › tests/fusion/fusion_s4_console.spec.ts:400:7 › Fusion S4 console › GET /api/fusion/soak-summary contract (97ms)
  ✓   9 [chromium] › tests/fusion/fusion_s4_console.spec.ts:422:7 › Fusion S4 console › GET /api/fusion/challenge-ledger read contract (43ms)
  ✓  10 [chromium] › tests/fusion/fusion_s4_console.spec.ts:430:7 › Fusion S4 console › POST /api/fusion/challenge-ledger registers team (secret) (91ms)
  ✓  11 [chromium] › tests/fusion/fusion_s4_console.spec.ts:452:7 › Fusion S4 console › GET /api/fusion/global-challenge-digest (287ms)
  ✓  12 [chromium] › tests/fusion/fusion_s4_console.spec.ts:462:7 › Fusion S4 console › GET /api/fusion/soak-summary markdown export (227ms)
  ✓  13 [chromium] › tests/fusion/fusion_s4_console.spec.ts:471:7 › Fusion S4 console › /fusion-s4 UI panels (1.1s)
  ✓  14 [chromium] › tests/fusion/fusion_s4_console.spec.ts:491:7 › Fusion S4 console › WASM projection event propagates from bridge payload to control shell and viewport (2.1s)
  ✓  15 [chromium] › tests/fusion/fusion_s4_console.spec.ts:695:7 › Fusion S4 console › WASM UI self-heals missing anchors and UI state without external input (2.8s)
  ✓  16 [chromium] › tests/fusion/fusion_s4_console.spec.ts:818:7 › Fusion S4 console › Soak table lists four JSONL tracks (1.7s)
  ✓  17 [chromium] › tests/fusion/fusion_s4_console.spec.ts:825:7 › Fusion S4 console › OpenUSD gameplay witness: run matrix + USD overlay hash (3.3s)
  ✓  18 [chromium] › tests/fusion/fusion_s4_console.spec.ts:866:7 › Fusion S4 console › MSV Stage 4 linguistic eversion + low-latency MUTATE_VARIANT witness (1.7s)
  ✓  19 [chromium] › tests/fusion/fusion_s4_doc.spec.ts:11:7 › Fusion S4 documentation capture › full-page screenshot @fusion-doc (2.0s)
  ✓  20 [chromium] › tests/fusion/gate1_page.spec.ts:7:7 › GATE1 page › gate1 page loads and shows custody copy (841ms)
  ✓  21 [chromium] › tests/fusion/gate1_page.spec.ts:13:7 › GATE1 page › gate1-register-options GET returns JSON (30ms)
  ✓  22 [chromium] › tests/fusion/gate1_page.spec.ts:21:7 › GATE1 page › gate1-register-options POST is 403 until GATE1_LIFT=1 (26ms)
...
[0/4] Copying default.metallib
[1/5] Copying gaiafusion_substrate.wasm
...
Test Suite 'All tests' started at 2026-04-10 08:46:01.449.
Test Suite 'GaiaFusionPackageTests.xctest' started at 2026-04-10 08:46:01.450.
Test Suite 'CellStateTests' started at 2026-04-10 08:46:01.450.
...
Test Suite 'CellStateTests' passed at 2026-04-10 08:46:01.452.
	 Executed 2 tests, with 0 failures (0 unexpected) in 0.002 (0.002) seconds
Test Suite 'ConfigValidationTests' started at 2026-04-10 08:46:01.452.
Test Case '-[GaiaFusionTests.ConfigValidationTests testFileTreeReturnsConfiguredRoot]' started.
Test Case '-[GaiaFusionTests.ConfigValidationTests testFileTreeReturnsConfiguredRoot]' passed (0.005 seconds).
Test Case '-[GaiaFusionTests.ConfigValidationTests testFusionCellRuntimeConfigURLMatchesRunnerPath]' started.
Test Case '-[GaiaFusionTests.ConfigValidationTests testFusionCellRuntimeConfigURLMatchesRunnerPath]' passed (0.003 seconds).
...
Test Suite 'ConfigValidationTests' passed at 2026-04-10 08:46:01.462.
	 Executed 4 tests, with 0 failures (0 unexpected) in 0.009 (0.010) seconds
Test Suite 'LocalServerAPITests' started at 2026-04-10 08:46:01.462.
Test Case '-[GaiaFusionTests.LocalServerAPITests testBridgeStatusEndpointReportsBooleanShape]' started.
Test Case '-[GaiaFusionTests.LocalServerAPITests testBridgeStatusEndpointReportsBooleanShape]' passed (0.085 seconds).
Test Case '-[GaiaFusionTests.LocalServerAPITests testCellsEndpointReturnsAllConfiguredNodes]' started.
Test Case '-[GaiaFusionTests.LocalServerAPITests testCellsEndpointReturnsAllConfiguredNodes]' passed (0.017 seconds).
Test Case '-[GaiaFusionTests.LocalServerAPITests testFleetDigestEndpointReturnsTopologyShape]' started.
Test Case '-[GaiaFusionTests.LocalServerAPITests testFleetDigestEndpointReturnsTopologyShape]' passed (0.020 seconds).
Test Case '-[GaiaFusionTests.LocalServerAPITests testHealthEndpointReturnsOperationalPayload]' started.
Test Case '-[GaiaFusionTests.LocalServerAPITests testHealthEndpointReturnsOperationalPayload]' passed (0.018 seconds).
Test Case '-[GaiaFusionTests.LocalServerAPITests testPlantKindsEndpointReturnsCanonicalKinds]' started.
Test Case '-[GaiaFusionTests.LocalServerAPITests testPlantKindsEndpointReturnsCanonicalKinds]' passed (0.022 seconds).
...
Test Case '-[GaiaFusionTests.LocalServerAPITests testSelfProbeEndpointReturnsSchemaAndBridgeGate]' passed (0.018 seconds).
...
Test Case '-[GaiaFusionTests.LocalServerAPITests testSwapEndpointRejectsWithoutQuorum]' passed (0.021 seconds).
Test Case '-[GaiaFusionTests.LocalServerAPITests testSwapRejectsUnknownPlantKind]' started.
Test Case '-[GaiaFusionTests.LocalServerAPITests testSwapRejectsUnknownPlantKind]' passed (0.017 seconds).
Test Case '-[GaiaFusionTests.LocalServerAPITests testSwapRejectsUnsupportedPlantKind]' started.
Test Case '-[GaiaFusionTests.LocalServerAPITests testSwapRejectsUnsupportedPlantKind]' passed (0.018 seconds).
Test Suite 'LocalServerAPITests' passed at 2026-04-10 08:46:01.735.
	 Executed 11 tests, with 0 failures (0 unexpected) in 0.271 (0.273) seconds
Test Suite 'MeshProbeTests' started at 2026-04-10 08:46:01.735.
...
Test Suite 'MeshProbeTests' passed at 2026-04-10 08:46:01.737.
	 Executed 2 tests, with 0 failures (0 unexpected) in 0.002 (0.002) seconds
Test Suite 'PlantKindsCatalogTests' started at 2026-04-10 08:46:01.737.
...
Test Suite 'PlantKindsCatalogTests' passed at 2026-04-10 08:46:01.738.
	 Executed 4 tests, with 0 failures (0 unexpected) in 0.001 (0.001) seconds
Test Suite 'SwapLifecycleTests' started at 2026-04-10 08:46:01.738.
...
Test Suite 'SwapLifecycleTests' passed at 2026-04-10 08:46:01.739.
	 Executed 3 tests, with 0 failures (0 unexpected) in 0.001 (0.001) seconds
Test Suite 'GaiaFusionPackageTests.xctest' passed at 2026-04-10 08:46:01.739.
	 Executed 26 tests, with 0 failures (0 unexpected) in 0.285 (0.289) seconds
Test Suite 'All tests' passed at 2026-04-10 08:46:01.739.
	 Executed 26 tests, with 0 failures (0 unexpected) in 0.285 (0.290) seconds
...
STATE: CALORIE
REPORT_JSON: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/fusion_control/RELEASE_REPORT_20260410T124459Z.json
REPORT_MD: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/fusion_control/RELEASE_REPORT_20260410T124459Z.md
