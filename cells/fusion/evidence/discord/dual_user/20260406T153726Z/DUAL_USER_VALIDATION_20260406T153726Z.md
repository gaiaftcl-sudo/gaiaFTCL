...
- ts_utc: 20260406T153726Z
- out_dir: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/discord/dual_user/20260406T153726Z
...
Running 1 test using 1 worker
  ...
  ✘  1 [chromium] › tests/discord/discord_dual_user_validation.spec.ts:63:7 › Dual-user sovereign handshake › live moorer + observer convergence (23.1s)


  1) [chromium] › tests/discord/discord_dual_user_validation.spec.ts:63:7 › Dual-user sovereign handshake › live moorer + observer convergence 
    ...
    Expected: not [32m"gaiaftcl-discord-bot-governance"[39m
      ...
      147 |     if (!releaseA || !releaseB) throw new Error(`REFUSED: missing release_id in responses (A=${releaseA ?? "none"}, B=${releaseB ?? "none"})`);
      148 |     expect(releaseA).toBe(releaseB);
    > 149 |     expect(sourceA).not.toBe(sourceB);
          |                         ^
      150 |     expect(convergenceMs).toBeLessThanOrEqual(2000);
      151 |   });
      152 | });
        at /Users/richardgillespie/Documents/FoT8D/cells/fusion/services/gaiaos_ui_web/tests/discord/discord_dual_user_validation.spec.ts:149:25
  ...
  1 failed
    [chromium] › tests/discord/discord_dual_user_validation.spec.ts:63:7 › Dual-user sovereign handshake › live moorer + observer convergence 
