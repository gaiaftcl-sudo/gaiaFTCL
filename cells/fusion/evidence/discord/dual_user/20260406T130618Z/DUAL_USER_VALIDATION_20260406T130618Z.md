...
- ts_utc: 20260406T130618Z
- out_dir: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/discord/dual_user/20260406T130618Z
...
Running 1 test using 1 worker
  ...
  ✘  1 [chromium] › tests/discord/discord_dual_user_validation.spec.ts:41:7 › Dual-user sovereign handshake › live moorer + observer convergence (10.5s)


  1) [chromium] › tests/discord/discord_dual_user_validation.spec.ts:41:7 › Dual-user sovereign handshake › live moorer + observer convergence 

    Error: REFUSED: missing source in responses (A=none, B=none)

      116 |     fs.writeFileSync(witnessPath, JSON.stringify(witness, null, 2), "utf-8");
      117 |
    > 118 |     if (!sourceA || !sourceB) throw new Error(`REFUSED: missing source in responses (A=${sourceA ?? "none"}, B=${sourceB ?? "none"})`);
          |                                     ^
      119 |     if (!releaseA || !releaseB) throw new Error(`REFUSED: missing release_id in responses (A=${releaseA ?? "none"}, B=${releaseB ?? "none"})`);
      120 |     expect(releaseA).toBe(releaseB);
      121 |     expect(sourceA).not.toBe(sourceB);
        at /Users/richardgillespie/Documents/FoT8D/cells/fusion/services/gaiaos_ui_web/tests/discord/discord_dual_user_validation.spec.ts:118:37
  ...
  1 failed
    [chromium] › tests/discord/discord_dual_user_validation.spec.ts:41:7 › Dual-user sovereign handshake › live moorer + observer convergence 
