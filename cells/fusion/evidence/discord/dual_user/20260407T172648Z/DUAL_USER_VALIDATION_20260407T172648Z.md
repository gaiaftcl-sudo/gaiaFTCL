...
- ts_utc: 20260407T172648Z
- out_dir: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/discord/dual_user/20260407T172648Z
...
Running 1 test using 1 worker
  ...
  1) [chromium] › tests/discord/discord_dual_user_validation.spec.ts:127:7 › Dual-user sovereign handshake › live moorer + observer convergence 
    ...
    Received:    [31m2133[39m

      307 |     expect(releaseA).toBe(releaseB);
      308 |     expect(sourceA).not.toBe(sourceB);
    > 309 |     expect(convergenceMs).toBeLessThanOrEqual(2000);
          |                           ^
      310 |
      311 |     if (requireEarth && !earthFullMoor) {
      312 |       throw new Error(
