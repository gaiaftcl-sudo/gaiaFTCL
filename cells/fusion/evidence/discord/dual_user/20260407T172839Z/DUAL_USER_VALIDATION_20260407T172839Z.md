...
- ts_utc: 20260407T172839Z
- out_dir: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/discord/dual_user/20260407T172839Z
...
Running 1 test using 1 worker
  ...
  ✘  1 [chromium] › tests/discord/discord_dual_user_validation.spec.ts:127:7 › Dual-user sovereign handshake › live moorer + observer convergence (2.9m)
  ...
  1) [chromium] › tests/discord/discord_dual_user_validation.spec.ts:127:7 › Dual-user sovereign handshake › live moorer + observer convergence 
    ...
    Received:    [31m3342[39m

      307 |     if (!releaseA || !releaseB) throw new Error(`REFUSED: missing release_id in responses (A=${releaseA ?? "none"}, B=${releaseB ?? "none"})`);
    ...
    > 309 |     expect(sourceA).not.toBe(sourceB);
      ...
      312 |     if (requireEarth && !earthFullMoor) {
        at /Users/richardgillespie/Documents/FoT8D/cells/fusion/services/gaiaos_ui_web/tests/discord/discord_dual_user_validation.spec.ts:309:27

    Error: browserContext._wrapApiCall: ENOENT: no such file or directory, open '/Users/richardgillespie/Documents/FoT8D/cells/fusion/services/gaiaos_ui_web/test-results/.playwright-artifacts-0/traces/resources/page@f3ce2a0a03b01cd4b6a9a1244737ac57-1775582966473.jpeg'
