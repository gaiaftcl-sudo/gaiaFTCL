...
- ts_utc: 20260406T153916Z
- out_dir: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/discord/dual_user/20260406T153916Z
...
Running 1 test using 1 worker
  ...
  ✘  1 [chromium] › tests/discord/discord_dual_user_validation.spec.ts:75:7 › Dual-user sovereign handshake › live moorer + observer convergence (23.5s)
  ...
  1) [chromium] › tests/discord/discord_dual_user_validation.spec.ts:75:7 › Dual-user sovereign handshake › live moorer + observer convergence 
    ...
    Expected: not [32m"gaiaftcl-discord-bot-governance"[39m
      ...
      159 |     if (!releaseA || !releaseB) throw new Error(`REFUSED: missing release_id in responses (A=${releaseA ?? "none"}, B=${releaseB ?? "none"})`);
      160 |     expect(releaseA).toBe(releaseB);
    > 161 |     expect(sourceA).not.toBe(sourceB);
          |                         ^
      162 |     expect(convergenceMs).toBeLessThanOrEqual(2000);
      163 |   });
      164 | });
        at /Users/richardgillespie/Documents/FoT8D/cells/fusion/services/gaiaos_ui_web/tests/discord/discord_dual_user_validation.spec.ts:161:25
