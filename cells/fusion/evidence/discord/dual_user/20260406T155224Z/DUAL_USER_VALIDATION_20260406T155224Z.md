...
- ts_utc: 20260406T155224Z
- out_dir: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/discord/dual_user/20260406T155224Z
...
Running 1 test using 1 worker
  ...
  ✘  1 [chromium] › tests/discord/discord_dual_user_validation.spec.ts:75:7 › Dual-user sovereign handshake › live moorer + observer convergence (40.6s)


  1) [chromium] › tests/discord/discord_dual_user_validation.spec.ts:75:7 › Dual-user sovereign handshake › live moorer + observer convergence 

    Error: REFUSED: missing source in responses (A=none, B=gaiaftcl-discord-bot-governance)

      160 |     fs.writeFileSync(witnessPath, JSON.stringify(witness, null, 2), "utf-8");
      161 |
    > 162 |     if (!sourceA || !sourceB) throw new Error(`REFUSED: missing source in responses (A=${sourceA ?? "none"}, B=${sourceB ?? "none"})`);
          |                                     ^
      163 |     if (!releaseA || !releaseB) throw new Error(`REFUSED: missing release_id in responses (A=${releaseA ?? "none"}, B=${releaseB ?? "none"})`);
      164 |     expect(releaseA).toBe(releaseB);
      165 |     expect(sourceA).not.toBe(sourceB);
        at /Users/richardgillespie/Documents/FoT8D/cells/fusion/services/gaiaos_ui_web/tests/discord/discord_dual_user_validation.spec.ts:162:37
  ...
  1 failed
    [chromium] › tests/discord/discord_dual_user_validation.spec.ts:75:7 › Dual-user sovereign handshake › live moorer + observer convergence 
