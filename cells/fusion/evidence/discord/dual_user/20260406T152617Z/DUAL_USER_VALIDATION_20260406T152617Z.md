...
- ts_utc: 20260406T152617Z
- out_dir: /Users/richardgillespie/Documents/FoT8D/cells/fusion/evidence/discord/dual_user/20260406T152617Z
...
REFRESH owl app_id=1490456471811653874 get=200 put=400 count=5 source=global
REFRESH governance app_id=1490456095649431745 get=200 put=400 count=8 source=global
...
Running 1 test using 1 worker
  ...
  ✘  1 [chromium] › tests/discord/discord_dual_user_validation.spec.ts:48:7 › Dual-user sovereign handshake › live moorer + observer convergence (16.7s)
  ...
  1) [chromium] › tests/discord/discord_dual_user_validation.spec.ts:48:7 › Dual-user sovereign handshake › live moorer + observer convergence 
    ...
    > 125 |     if (!sourceA || !sourceB) throw new Error(`REFUSED: missing source in responses (A=${sourceA ?? "none"}, B=${sourceB ?? "none"})`);
      ...
      128 |     expect(sourceA).not.toBe(sourceB);
        at /Users/richardgillespie/Documents/FoT8D/cells/fusion/services/gaiaos_ui_web/tests/discord/discord_dual_user_validation.spec.ts:125:37
