...
| Swift unit contracts | `cells/fusion/macos/MacHealth/Tests/SILV2/` |
| CI workflow | `.github/workflows/mac-cell-ci.yml` job **MacHealth — SIL V2 swift test** → `swift test` in `cells/fusion/macos/MacHealth` |
