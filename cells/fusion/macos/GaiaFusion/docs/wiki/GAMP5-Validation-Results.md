...
📄 **HTML evidence report:** generated by your validation run (`scripts/run_master_gamp5_validation.sh` when present). For the public wiki mirror of this page, see **[GAMP5 Validation Results](https://github.com/gaiaftcl-sudo/gaiaFTCL/wiki/GAMP5-Validation-Results)**.
...
*RT-002 screenshot: captured during the validation run; not checked into this mirror.*

*Metal-rendered fusion plant geometry correctly centered in viewport.*

### RT-006: Constitutional HUD

*RT-006 screenshot: captured during the validation run; not checked into this mirror.*
