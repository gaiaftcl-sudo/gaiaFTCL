...
# Invoked from repo root (FoT8D): zsh cells/fusion/macos/GaiaFTCLConsole/scripts/lint_sparkle_release.sh
# ROOT resolves to cells/fusion/ (three levels up from this file).
