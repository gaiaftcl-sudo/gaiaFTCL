...
func main() {
    ...
    // Get repo root (assumes TestRobot is in GAIAOS/macos/TestRobot)
    ...
    let mfReceiptPath = "\(repoRoot)/GAIAOS/macos/GaiaFusion/evidence/pq/macfusion_pq_receipt.json"
    ...
    let mhReceiptPath = "\(repoRoot)/GAIAOS/macos/MacHealth/evidence/pq/machealth_pq_receipt.json"
