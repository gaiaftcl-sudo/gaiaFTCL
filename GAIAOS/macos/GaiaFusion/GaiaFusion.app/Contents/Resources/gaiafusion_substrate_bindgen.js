/* @ts-self-types="./atc_physics_wasm.d.ts" */
...
export class PhysicsEngine {
     ...
     */
    aircraft_count() {
        const ret = wasm.physicsengine_aircraft_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    clear_aircraft() {
        wasm.physicsengine_clear_aircraft(this.__wbg_ptr);
    }
    /**
     * Get current tick
     * @returns {bigint}
     */
    current_tick() {
        const ret = wasm.physicsengine_current_tick(this.__wbg_ptr);
     ...
     */
    get_vchip_scale() {
        const ret = wasm.physicsengine_get_vchip_scale(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {number}
     */
    ingest_aircraft(json_data) {
        const ptr0 = passStringToWasm0(json_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.physicsengine_ingest_aircraft(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
    ...
    constructor(canvas_width, canvas_height) {
        const ret = wasm.physicsengine_new(canvas_width, canvas_height);
     ...
     */
    render(ctx) {
        wasm.physicsengine_render(this.__wbg_ptr, ctx);
    }
    /**
     * Set camera position
     * @param {number} lon
     ...
     * @param {number} zoom
     */
    set_camera(lon, lat, zoom) {
        wasm.physicsengine_set_camera(this.__wbg_ptr, lon, lat, zoom);
    }
    /**
     * Physics tick - advance the simulation
     */
    tick() {
        wasm.physicsengine_tick(this.__wbg_ptr);
    }
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_log_729e60cf20a0d22f: function(arg0, arg1) {
    ...
    return {
        __proto__: null,
        "./atc_physics_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('atc_physics_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
