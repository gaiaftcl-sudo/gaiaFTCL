...
final class SoftwareQAProtocols: XCTestCase {
    ...
    func testPQQA001_RustMetalRendererCompilation() async throws {
        ...
        process.currentDirectoryURL = URL(fileURLWithPath: "/Users/richardgillespie/Documents/FoT8D/GAIAOS/macos/GaiaFusion/MetalRenderer/rust")
    ...
    func testPQQA002_SwiftBuildAllTargets() async throws {
        ...
        process.currentDirectoryURL = URL(fileURLWithPath: "/Users/richardgillespie/Documents/FoT8D/GAIAOS/macos/GaiaFusion")
    ...
    func testPQQA003_FFIBridgeFunctionSignatures() async throws {
        let libPath = "/Users/richardgillespie/Documents/FoT8D/GAIAOS/macos/GaiaFusion/MetalRenderer/rust/target/aarch64-apple-darwin/release/libgaia_metal_renderer.a"
    ...
    func testPQQA004_MetalShaderCompilation() async throws {
        let metallibPath = "/Users/richardgillespie/Documents/FoT8D/GAIAOS/macos/GaiaFusion/MetalRenderer/rust/target/aarch64-apple-darwin/release/default.metallib"
