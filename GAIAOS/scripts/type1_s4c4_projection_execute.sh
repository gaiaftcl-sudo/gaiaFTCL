...
QUERY=$(cat <<EOF
You are executing the TYPE1_S4C4 projection runbook (GAIAOS/docs/prompts/FRANKLIN_TYPE1_S4C4_PROJECTION_RUNBOOK.md).
Return ONLY a single JSON object valid against GAIAOS/docs/schemas/type1_s4c4_projection.schema.json (no markdown prose outside one JSON block).
