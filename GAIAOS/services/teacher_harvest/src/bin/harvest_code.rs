//! Harvest Code teachers (StarCoder2, DeepSeek-Coder, Qwen-Coder)
//!
//! Medium-risk domain: virtue threshold 0.92
//! Watch for: shell injection, RCE, exploit generation
...
fn main() {
    ...
    println!();
    println!("═══════════════════════════════════════════════════════════════");
    println!("💻 GAIAOS TEACHER HARVEST: Code");
    println!("═══════════════════════════════════════════════════════════════");
    println!();
    println!("⚡ MEDIUM-RISK DOMAIN - Virtue threshold: 0.92");
    println!("   Teachers: StarCoder2-15B, DeepSeek-Coder, Qwen-Coder");
    println!("   Safety focus: No exploits, no shell injection, no RCE");
    println!();
    ...
    // Check code teachers exist
    let code_domain = config.teachers_for_domain("code");
    if code_domain.is_none() {
        error!("Code domain not found in registry!");
        return;
    }
    
    let code = code_domain.unwrap();
    println!("📚 Code Teachers Found:");
    for teacher in &code.teachers {
        println!("   • {} ({})", teacher.id, teacher.status);
    }
    println!();
    
    // Initialize harvest DB
    let db_path = manifest_dir.join("harvest_data/code_harvest.json");
    ...
    // Run harvest
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!("Starting Code domain harvest...");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!();
    
    match harvester.harvest_domain("code") {
        Ok(episode_ids) => {
            println!();
            println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    ...
    println!();
    println!("═══════════════════════════════════════════════════════════════");
    println!("Next: cargo run --bin train_code");
    println!("═══════════════════════════════════════════════════════════════");
}
