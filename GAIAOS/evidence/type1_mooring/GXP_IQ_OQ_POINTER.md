...
- `GAIAOS/infrastructure/vqbit_cursor_kit/scripts/type1_iq_oq_pq.py`
- Output schema: `GAIAOS/infrastructure/vqbit_cursor_kit/schemas/type1_receipt.v1.json`
- Latest local witness (when run): `GAIAOS/evidence/type1_mooring/last_type1_receipt.json`
