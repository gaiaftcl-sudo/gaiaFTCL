...
### File 1: New file — `GAIAOS/macos/GaiaFusion/GaiaFusion/Views/PlantKindPicker.swift`
...
### File 2: `GAIAOS/macos/GaiaFusion/GaiaFusion/GaiaFusionApp.swift`
...
### File 3: `GAIAOS/macos/GaiaFusion/GaiaFusion/Inspector/CellDetailTab.swift`
...
### File 4: `GAIAOS/macos/GaiaFusion/GaiaFusion/Inspector/InspectorPanel.swift`
...
### File 5: `GAIAOS/macos/GaiaFusion/GaiaFusion/Sidebar/FusionSidebarView.swift`
...
### File 6: `GAIAOS/macos/GaiaFusion/GaiaFusion/Sidebar/MeshCellListView.swift`

Same as FusionSidebarView. Context menu swap action reads from coordinator state, not from cell defaults.

### File 7: `GAIAOS/macos/GaiaFusion/GaiaFusion/AppMenu.swift`
...
6. No call to `swapWithDefaults` exists anywhere. Verify: `rg "swapWithDefaults" GAIAOS/macos/` returns zero results.
...
### File 1: `GAIAOS/macos/GaiaFusion/GaiaFusion/Services/ConfigFileManager.swift`
...
### File 2: `GAIAOS/macos/GaiaFusion/GaiaFusion/AppCoordinator.swift`
...
### File 4: `GAIAOS/macos/GaiaFusion/GaiaFusion/Inspector/ConfigEditorTab.swift`
...
3. `rg "config/" GAIAOS/macos/GaiaFusion/GaiaFusion/Services/ConfigFileManager.swift` shows `deploy/fusion_cell/` appears before `config/` in search order.
...
#### `GAIAOS/macos/GaiaFusion/Tests/SwapLifecycleTests.swift`
...
#### `GAIAOS/macos/GaiaFusion/Tests/LocalServerAPITests.swift`
...
5. `rg "swapWithDefaults" GAIAOS/macos/` returns zero.
6. `rg '"real"' GAIAOS/macos/GaiaFusion/GaiaFusion/GaiaFusionApp.swift` returns zero hardcoded swap values (string literals in non-alias-map context).
